/*
** color_spot.c for RT in /home/david/gtk/menu/version2.0/sphere
** 
** Made by david blervaque
** Login   <blerva_d@epitech.net>
** 
** Started on  Fri May 25 15:03:50 2012 david blervaque
** Last update Fri Jun  1 22:52:11 2012 christophe del fabbro
*/
...
void		create_button_for_color_spot(GtkWidget **g_sph_box,
					     GtkWidget *ptr_vbox)
{
  GtkWidget     *ptr_button[2];
  GtkWidget     *ptr_HBox;

  ptr_button[0]= gtk_button_new_with_label("Position");
...
void		color_spot(GtkWidget *widget, gpointer data)
{
  GtkWidget	*tmp;
  ...
  if (g_cr_col == 0)
    {
      ...
      create_button_for_color_spot(&g_sph_box, tmp);
      g_cr_col = 1;
    }
