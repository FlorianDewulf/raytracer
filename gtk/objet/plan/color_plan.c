/*
** color_plan.c for RT in /home/david/gtk/menu/version2.0/plan
** 
** Made by david blervaque
** Login   <blerva_d@epitech.net>
** 
** Started on  Fri May 25 17:45:39 2012 david blervaque
** Last update Fri Jun  1 22:33:35 2012 christophe del fabbro
*/
...
void		create_button_for_color_plan(GtkWidget **g_sph_box,
					     GtkWidget *ptr_vbox)
{
...
void		color_plan(GtkWidget *widget, gpointer data)
{
  GtkWidget	*tmp;
  ...
  if (g_cr_col == 0)
    {
      ...
      create_button_for_color_plan(&g_sph_box, tmp);
      g_cr_col = 1;
    }
