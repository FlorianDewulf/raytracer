...
** Last update Fri Jun  1 22:32:03 2012 christophe del fabbro
*/
...
void		create_button_for_color_cube(GtkWidget **g_sph_box,
					     GtkWidget *ptr_vbox)
{
...
void		color_cube(GtkWidget *widget, gpointer data)
{
  GtkWidget	*tmp;
  ...
  if (g_cr_col == 0)
    {
      ...
      create_button_for_color_cube(&g_sph_box, tmp);
      g_cr_col = 1;
    }
